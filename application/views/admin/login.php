...
<style>
    ...
    nav {
        ...
        gap: 20px;
        align-items: center;
        background-color:rgba(73, 2, 131, 0.68);
    ...
    button {
        background-color: rgb(245, 87, 39);
        border: none;
        cursor: pointer;
        width: 100%;
        padding: 10px 15px;
...
<header>
    <nav>
        <img class="img" src="https://waskita.amikom.ac.id/pluginfile.php/1/theme_moove/marketing1icon/1632322974/amikom_color_120.png" alt="">
        <div>
                    ...
                    <div class="form">
                        ...
                        <form action="<?php echo base_url("login/autentikasi"); ?>" method="POST"> 
                            <div class="login-form">
                                <div> 
                                <span>Username</span>
                                <input type="text" class="input" id="email" name="email" placeholder="Rasendriya">
                                <span class="mt-9">Password:</span>
                                <input type="password" class="input" id="password" name="password" placeholder="23.01.5051">
                            </div>
