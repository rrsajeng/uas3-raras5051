...
<body>
  <header>
    <nav>
      <img class="img"
        src="https://waskita.amikom.ac.id/pluginfile.php/1/theme_moove/marketing1icon/1632322974/amikom_color_120.png"
        alt="">
      <div>
  ...
  <div class="sidebar">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-sm-2 pt-2 text-black min-vh-50 ">
     ...
     <div class="btn-group-sm">
      ...
      <a href="">Email</a>
      <a href="23.01.5008_Alvinda Natasya_TambahData.html">Tambah Data</a>
